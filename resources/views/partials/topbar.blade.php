<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Nama User/Admin -->
    <div style="color: white; " class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">{{ auth()->user()->username }}</div>
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-1 me-lg-2" style="margin-right: 0;">
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
          ...
          <li><a class="dropdown-item" href="/profile/change_password"><i class="fas fa-key fa-sm fa-fw text-gray-400" style="margin-right: 10px;"></i>Change Password</a></li>
          <li>
